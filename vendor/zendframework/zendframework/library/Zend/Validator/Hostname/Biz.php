...
return array(
    ...
    3  => '/^[\x{002d}0-9a-záéíóöúü�ű]{1,63}$/iu',
    4  => '/^[\x{002d}0-9a-záæéíðóöúýþ]{1,63}$/iu',
    5  => '/^[\x{AC00}-\x{D7A3}]{1,17}$/iu',
    6  => '/^[\x{002d}0-9a-z�&����"įšūųž]{1,63}$/iu',
    7  => '/^[\x{002d}0-9a-z�����ģīķļ� ���šūž]{1,63}$/iu',
    8  => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøü�����9šŧž]{1,63}$/iu',
    9  => '/^[\x{002d}0-9a-zó�&�!�"���:źż]{1,63}$/iu',
